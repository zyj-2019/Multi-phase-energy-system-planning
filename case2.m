%% 代码背景说明
% 油田的基准情景是：两台48MW的燃气轮机（CCGT）用于供电，除此以外，电负荷需求通过从电网购电获取。供热完全由3台4MW燃气吸收式热泵（HPg）和36台10MW的天然气锅炉(EBg)满足
% 基准情景不满足低碳要求，也无法应对未来电价和碳价上涨的经济风险，所以本代码中展示的是Case2：允许加入可再生能源（风机和光伏）其他条件不变，仍可以从电网无限制购电
...
result_address = '/Users/zyj/Library/CloudStorage/OneDrive-mails.tsinghua.edu.cn/mac_研二/项目/油气田项目/考虑风光不确定性代码';
% 保存图片的位置
fig_address = '/Users/zyj/Library/CloudStorage/OneDrive-mails.tsinghua.edu.cn/mac_研二/项目/油气田项目/考虑风光不确定性代码';
stop_gap = 1E-4;
solve_time = 1E20;
...
grid_limit      = 1000;                  % 电网购电上限（假设值，MW）（总共191MW电负荷，燃机就有96MW装机，限制少了，可再生能源占比就会比较大）
...
a_result_cost  = value([cost/USD2CNY,cost_inv/USD2CNY,(cost_OM+cost_ramp)/USD2CNY,cost_fuel/USD2CNY,cost_net/USD2CNY,cost_CO2/USD2CNY]); % 单位为美元
